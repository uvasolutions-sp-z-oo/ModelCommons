> Historical implementation record from 2026-09-11. Its unverified status and
> owner-run instructions describe that checkpoint. See the
> [current iOS device evidence](ios-shared-models.md) for the later successful run.
